...
interface DestinationItineraries {
  [nights: string]: CityStay[];
}

interface TripItineraries {
  [destinationId: string]: DestinationItineraries;
}

export const TRIP_ITINERARIES: TripItineraries = {
    'northern-michigan': {
